...
PRODUCTS = [
    {"name": "iPhone 15", "slug": "iphone-15", "price": "450000.00", "stock": 10, "category": "electronics", "description": "Смартфон Apple iPhone 15 128GB"},
    {"name": "MacBook Air M2", "slug": "macbook-air-m2", "price": "650000.00", "stock": 5, "category": "electronics", "description": "Ноутбук Apple MacBook Air с чипом M2"},
    {"name": "AirPods Pro", "slug": "airpods-pro", "price": "125000.00", "stock": 20, "category": "electronics", "description": "Беспроводные наушники Apple AirPods Pro"},
    {"name": "Samsung Galaxy S24", "slug": "samsung-galaxy-s24", "price": "400000.00", "stock": 15, "category": "electronics", "description": "Флагманский смартфон Samsung"},
    {"name": "Футболка базовая", "slug": "basic-tshirt", "price": "5000.00", "stock": 100, "category": "clothing", "description": "Хлопковая базовая футболка"},
    {"name": "Джинсы slim fit", "slug": "slim-jeans", "price": "15000.00", "stock": 50, "category": "clothing", "description": "Классические джинсы slim fit"},
    {"name": "Кроссовки Nike Air", "slug": "nike-air", "price": "45000.00", "stock": 30, "category": "clothing", "description": "Удобные кроссовки Nike Air Max"},
    {"name": "Мастер и Маргарита", "slug": "master-margarita", "price": "3500.00", "stock": 40, "category": "books", "description": "М.А. Булгаков — классика русской литературы"},
    {"name": "Чистый код", "slug": "clean-code", "price": "12000.00", "stock": 25, "category": "books", "description": "Роберт Мартин — руководство по написанию качественного кода"},
    {"name": "Гантели 10кг", "slug": "dumbbells-10kg", "price": "18000.00", "stock": 20, "category": "sport", "description": "Разборные гантели 10 кг"},
    {"name": "Коврик для йоги", "slug": "yoga-mat", "price": "8000.00", "stock": 35, "category": "sport", "description": "Нескользящий коврик для йоги и фитнеса"},
]
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        order1 = Order.objects.create(user=users[0], total_price="575000.00", status="delivered", is_paid=True)
        ...
        order2 = Order.objects.create(user=users[1], total_price="15000.00", status="processing", is_paid=False)
